...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Parse JSON file and count lines in FASTQ files."
    )
    parser.add_argument("--json_file", help="The JSON file to be parsed.")
    parser.add_argument(
        "--original_bam_file", help="The original BAM file to be parsed."
    )
    ...
    parse_data(
        args.json_file, args.original_bam_file, args.deduped_bam_file, args.sample_name
    )
