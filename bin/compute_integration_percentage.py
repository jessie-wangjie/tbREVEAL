    ...
    for index, row in target_info_df.iterrows():
        ...
        with pysam.AlignmentFile(alignment_file, "rb") as alignment:
            for read in alignment:
                ...
                rules = [
                    (read.reference_name == 'attL_amplicon' and 'CAS' in row['id'] and alignment_start > 33 or alignment_end < 69,
                     ['ambiguous_attL']),
                    ...
                    (read.reference_name == 'attR_amplicon' and 'CAS' in row['id'] and alignment_start > 21 or alignment_end < 57,
                     ['ambiguous_attR']),
                    ...
                    (read.reference_name == 'attL_amplicon' and 'AA' in row['id'] and alignment_start > 29 or alignment_end < 65,
                     ['ambiguous_attL']),
                    ...
                    (read.reference_name == 'attR_amplicon' and 'AA' in row['id'] and alignment_start < 21 or alignment_end < 57,
                     ['ambiguous_attR']),
